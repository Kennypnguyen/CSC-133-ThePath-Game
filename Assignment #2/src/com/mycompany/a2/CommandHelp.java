...
public class CommandHelp extends Command {
	...
	public void actionPerformed(ActionEvent e) {
		...
		Dialog helpBox = new Dialog("Help", new TableLayout(12, 2));
		...
		helpBox.add(new Label("Press f"));
		helpBox.add(new Label("To collide with a food station"));
		helpBox.add(new Label("Press g"));
		helpBox.add(new Label("To collide with a spider"));
		helpBox.add(new Label("Press t"));
		helpBox.add(new Label("To tick the game clock"));
